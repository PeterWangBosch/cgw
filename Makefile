...
SOURCES = $(PROG).c src/bs_core.c src/file_utils.c src/bs_eth_installer_job.c src/bs_dlc_apis.c src/bs_cgw_utils.c src/bs_tdr_job.c mongoose/mongoose.c cJSON/cJSON.c
